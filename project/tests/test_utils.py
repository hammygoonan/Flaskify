...
from project.utils.scanner import ignore_directory
from project.utils.scanner import get_track_details
from project.utils.scanner import process_track_data
from project.utils.scanner import create_artist
from project.utils.scanner import create_album
from project.utils.scanner import create_song
...
def test_process_track_data_creates_album_artist(db):
    ...
    assert album.album_artists[0].name == 'DJ Mustard'
